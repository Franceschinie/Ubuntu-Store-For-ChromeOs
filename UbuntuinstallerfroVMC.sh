...
lxc exec penguin -- echo "Ubuntu on crostini integration setup"
lxc exec penguin -- echo "1 starting and upgrading package manager"
lxc exec penguin -- sudo apt update
lxc exec penguin -- sudo apt upgrade -y
lxc exec penguin -- echo "2 add sources and keys"
...
lxc exec penguin -- echo "3 download packages"
lxc exec penguin -- sudo apt update
...
lxc exec penguin -- echo "4 install libraries"
lxc exec penguin -- sudo apt install libgtk-3-0 -y
lxc exec penguin -- sudo dpkg --configure -a
lxc exec penguin -- echo "5 making apps compatibile with ubuntu"
...
lxc exec penguin -- echo "6 install apps"
...
lxc exec penguin -- echo "7 cleanup and reboot container"
